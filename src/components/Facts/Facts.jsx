...
const Facts = () => {
    return (
        <section className="mt-[140px]">
            <Container>
                <div className="bg-[#4F52C1] md:bg-[url(assets/factsBG.png)] bg-cover bg-no-repeat bg-center rounded-4xl pt-11 pb-11 md:pb-0 px-4 md:px-0 mx-7">
                        ...
                        <div className="md:w-[608px] mt-12">
                            ...
                            <Flex className="flex-col md:flex-row justify-between items-center mt-10 md:mt-16 text-center">
                                <div>
                                    ...
                                    <p className="font-secondary font-medium text-lg text-white w-[174px] mt-1.5 md:mt-0">Over 500 business powered with us</p>
                                </div>
                                <div className="mt-7">
                                    <h2 className="font-primary font-bold text-[44px] text-white">4.9</h2>
                                    <p className="font-secondary font-medium text-lg text-white w-[174px] mt-1.5 md:mt-0">Rating on google play and app store</p>
                                </div>
                                <div className="mt-7">
                                    <h2 className="font-primary font-bold text-[44px] text-white">200+</h2>
                                    <p className="font-secondary font-medium text-lg text-white w-[174px] mt-1.5 md:mt-0">Easily integrate with your favorite apps</p>
                                </div>
                            </Flex>
                        </div>
                    </Flex>
